...
define ("DB_NAME","contact_info"); // set database name

$link = mysql_connect(DB_HOST, DB_USER, DB_PASS) or die("Couldn't make connection.");
$db = mysql_select_db(DB_NAME, $link) or die("Couldn't select database");

$databasetable = "contact_list";
...
$query = "SELECT fname FROM contact_list WHERE fname = '".$userName."' and email = '".$userMobile."'";
$sql = mysql_query($query);
$recResult = mysql_fetch_array($sql);
$existName = $recResult["fname"];
if($existName=="") {
$insertTable= mysql_query("insert into contact_list (fname, email) values('".$userName."', '".$userMobile."');");
